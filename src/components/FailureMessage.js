...
export default function FailureMessage() {
    ...
    const {isFailureMessageBox, setIsFailureMessageBox} = useContext(MyContext);
    const {failureMessage, setFailureMessage} = useContext(MyContext);

    const closeMessageBox = () => {
        setIsFailureMessageBox(false);
    }
    return (
        <>
            <>
                ...
                >
                    ...
                    <button
                        ...
                        aria-label="Close"  onClick={closeMessageBox}
                    >
