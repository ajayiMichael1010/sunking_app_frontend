...
function Sidebar() {
    ...
    return (
        <>
            <nav
                id="sidenav-8"
                className="absolute left-0 top-0 z-[1035] w-60 -translate-x-full overflow-hidden bg-yellow-300 shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
            ...
            >
                <Link
                    ...
                    <img id="te-logo" className="mr-2 w-32" src="https://sunking.com/wp-content/uploads/2017/12/Sun-King-Logo-1.png" alt="TE Logo" draggable="false" width={300}/>
                    {/*<span>King Sun</span>*/}
                </Link>
                <ul className="relative m-0 list-none px-[0.2rem] pb-12" data-te-sidenav-menu-ref="">
                    ...
                    <li className="relative">
                        <a
                            ...
                            href={`/staff/record`}
                        >
                            <ItemSpacing />  <span>Staff Record</span>
                        </a>
                    </li>
