                        ...
                        <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                            <div className="overflow-hidden">
                                ...
                                <table className="min-w-full text-left text-sm font-light">
                                    ...
                                    <tr
                                        className="border-b bg-neutral-100">
                                        <td className="whitespace-nowrap px-8 py-4 font-medium">Nationality</td>
                                        <td className="whitespace-nowrap px-6 py-4">{userData.nationality}</td>
                                    </tr>
                                    <tr
                                        className="border-b">
                                    ...
                                    <tr
                                        className="border-b bg-neutral-100">
                                        <td className="whitespace-nowrap px-8 py-4 font-medium">Address</td>
                                        <td className="whitespace-nowrap px-6 py-4">{userData.address}</td>
                                    </tr>
